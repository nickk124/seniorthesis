...
\include{section_abstract}              %% Abstract
...
\include{section_introduction}        %% this is a suggestion: you have to create this file on demand
%\addcontentsline{toc}{chapter}{The TRK Statistic}
\include{section_TRK}             %% this is a suggestion: you have to create this file on demand
\include{section_properties}
%\addcontentsline{toc}{chapter}{The TRK Fitting Algorithm}
\include{section_code1}            %% this is a suggestion: you have to create this file on demand
\include{section_code2}  
% include the
...
\include{section_applications}             %% this is a suggestion: you have to create this file on demand

\include{section_future}  

\appendix                       %% closes main document, appendix follows until end; only available in book-classes
%\addpart*{Appendix}             %% adding Appendix to tableofcontents
\include{appendix_algos}
